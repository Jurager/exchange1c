...
use Jurager\Exchange1C\Events\AfterOffersSync;
use Jurager\Exchange1C\Events\AfterUpdateOffer;
use Jurager\Exchange1C\Events\BeforeOffersSync;
use Jurager\Exchange1C\Events\BeforeUpdateOffer;
...
use Jurager\Exchange1C\Interfaces\OfferInterface;
